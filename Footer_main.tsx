...
const Footer = () => {
  ...
  return (
    <footer className="relative mt-auto w-full bg-[#F0F4FF] border-t border-[#2563EB]/[0.06] py-8">
        ...
        <div className="flex items-center gap-6">
          {[
            ...
            <button
              ...
              className="text-[12px] font-medium text-[#4B5563] hover:text-[#2563EB] transition-colors"
            >
              {link.label}
            </button>
          ))}
