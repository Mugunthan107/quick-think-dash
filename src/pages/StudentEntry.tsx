      ...
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Enter the PIN from your instructor</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-8">
          ...
          <Button type="submit" className="w-full h-13 bg-accent text-accent-foreground hover:bg-accent/90 font-semibold rounded-xl text-base py-3.5">
            Start Test
          </Button>
        </form>
      </div>
